...
EAPI void _edje_pick_context_set(Edje_Pick *c);
EAPI Edje_Pick *_edje_pick_context_get();
...
EAPI const char * _edje_pick_err_str_get(Edje_Pick_Status s);
EAPI int _edje_pick_process(int argc, char **argv);
#endif
